...
function update_bot() {
  ...
  if git pull origin "$branch"; then
    python3 -m pip install -r requirements.txt || python3 -m pip install -r requirements.txt --break-system-packages || display_error_and_exit "Failed to install requirements."
